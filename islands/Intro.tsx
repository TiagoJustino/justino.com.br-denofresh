    ...
    return (
        <>
            <div className="md:flex items-center"><p>
                ...
                className="text-blue-500 hover:text-blue-700 hover:underline"
                href="https://www.rit.edu/study/human-computer-interaction-ms">Rochester
                Institute of Technology</a>,
                co-fundador da <a
                className="text-blue-500 hover:text-blue-700 hover:underline"
                href="https://www.cubienergia.com/">CUBi
                Energia</a>,
                atualmente morando em <a
                className="text-blue-500 hover:text-blue-700 hover:underline"
                href="https://maps.app.goo.gl/LjkzcsHr8w6SV8nt9">Montreal QC, Canada.</a>
            </p></div>
            <div className="md:flex items-center"><p>
                Para conhecer mais sobre minha experiência profissional acesse meu currículo ( <a
                className="text-blue-500 hover:text-blue-700 hover:underline"
...
export function Intro({state, setState}: {state: {lang: string}, setState: Function}) {
    return (
        <>
