  ...
  return (
    <>
      <div className='md:flex items-center'>
        <p>
          Sou Tiago Justino, desenvolvedor de software com quase 20 anos de experiência, bacharel em Ciências da
          Computação pela{' '}
          <a
      ...
      <div className='md:flex items-center'>
        <p>
          Para conhecer mais sobre minha experiência profissional acesse meu currículo ({' '}
          <a
            className='text-blue-500 hover:text-blue-700 hover:underline'
...
function TextEn() {
  return (
    <>
      <div className='md:flex items-center'>
        <p>
          I am Tiago Justino, software developer with almost 20 years of experience, BS in Computer Science from{' '}
          <a
            className='text-blue-500 hover:text-blue-700 hover:underline'
            href='https://www.uece.br/cct/ciencias-da-computacao/'
          >
      ...
      <div className='md:flex items-center'>
        <p>
          To know more about my professional experience please download my Résumé ({' '}
          <a
            className='text-blue-500 hover:text-blue-700 hover:underline'
            href='/tiago-justino-resume-en-us.pdf'
          >
